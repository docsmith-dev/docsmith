...
export interface BreadcrumbsProps extends React.HTMLAttributes<HTMLElement> {
  renderItem?: (props: { item: { name: string; slug: string }; isLast: boolean }) => React.ReactNode;
...
export interface SearchProps extends React.HTMLAttributes<HTMLDivElement> {
  renderInput?: (props: { inputProps: React.InputHTMLAttributes<HTMLInputElement> }) => React.ReactNode;
  renderResults?: (props: { results: Doc[]; resultProps: any; query: string }) => React.ReactNode;
...
export interface OnThisPageProps extends React.HTMLAttributes<HTMLElement> {
  renderItem?: (props: { heading: { id: string; text: string; level: number }; isActive: boolean }) => React.ReactNode;
  renderList?: (props: { children: React.ReactNode }) => React.ReactNode;
